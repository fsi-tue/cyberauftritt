...
task :test do
  options = { # Documentation: https://github.com/gjtorikian/html-proofer#configuration
    :url_ignore => [/^https:\/\/www\.blablacar\.de/,/^https:\/\/useplaintext\.email/,/^https:\/\/www\.hih-tuebingen\.de/,/^https:\/\/www\.vhs-tuebingen\.de/,/^https:\/\/ppi\.fsi\.uni-tuebingen\.de/,/^https:\/\/twitter\.com/,/^https:\/\/www\.kyb\.tuebingen\.mpg\.de/,/^https:\/\/uni-tuebingen\.de\/studium\/studieninteresse\/angebote-fuer-studieninteressierte\/studieninfotag\//],
